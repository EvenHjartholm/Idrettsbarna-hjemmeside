...
export const SCHEDULE_DATA: ScheduleDay[] = [
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: "12:45 - 13:10", level: "Babysvømming", ageGroup: "Nybegynner og Øvet", serviceId: "baby", spots: "Venteliste", waitlistNote: "Se torsdager kl. 15:30 – ledige plasser" },
      { time: "13:10 - 13:35", level: "Babysvømming", ageGroup: "Nybegynner", serviceId: "baby", spots: "Venteliste", waitlistNote: "Se torsdager kl. 15:30 – ledige plasser" },
