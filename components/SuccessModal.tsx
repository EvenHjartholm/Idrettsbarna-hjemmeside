    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                {/* Modal Content */}
                <div className="relative transform overflow-hidden rounded-3xl bg-slate-900 text-left shadow-xl transition-all sm:my-8 w-full max-w-lg border border-green-500/30 animate-fade-in-up">
                    ...
                    <div className="p-8 text-center relative z-10">
                        ...
                        <button
                            onClick={onClose}
                            className="mt-8 px-8 py-3 bg-green-600 hover:bg-green-500 text-white font-bold rounded-full transition-all shadow-lg shadow-green-900/20 hover:scale-105 w-full sm:w-auto"
                        >
                            Lukk vinduet
                        </button>
