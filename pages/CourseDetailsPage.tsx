...
const CourseDetailsPage: React.FC<CourseDetailsPageProps> = ({ theme }) => {
    ...
    return (
        <>
            <div
                className="min-h-screen bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-start p-4 sm:p-6 lg:p-8 pb-32 sm:pb-8"
                ...
                <div className="relative w-full max-w-5xl bg-slate-900 rounded-3xl shadow-2xl border border-white/10 flex flex-col overflow-hidden animate-fade-in-up z-10">
                    ...
                    <div className="px-8 pt-8 pb-4 bg-slate-900">
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                            ...
                            {/* Enroll Button - Force Update 5 - Revert to SM */}
                            <button
                                onClick={handleEnroll}
                                className="hidden sm:flex group relative p-[1px] rounded-full overflow-hidden shadow-[0_0_20px_rgba(6,182,212,0.1)] hover:shadow-[0_0_30px_rgba(6,182,212,0.4)] hover:-translate-y-0.5 transition-all shrink-0"
                            ...
                            >
                                ...
                                <div className="relative h-full w-full bg-cyan-950/80 hover:bg-cyan-950/60 rounded-full px-8 py-4 flex items-center justify-center gap-3 backdrop-blur-sm transition-colors">
                                    {course.id === 'lifesaving' || course.id === 'preschool' ? (
                            ...
                            <div className="bg-slate-800/30 rounded-2xl p-8 border border-white/5">
                                ...
                                <div className="mt-6 pt-6 border-t border-white/5">
                                    <div className="flex items-start gap-3 text-slate-400 text-sm">
                                        ...
                                        <p>
                                            {(() => {
                                                if (course.id === 'baby') return "Inngangsbillett (0-3 år): Forelder betaler, babyen er gratis. Inngang kjøpes på Risenga.";
                                                if (course.id === 'toddler') return (
                                                    <>
                                                        Inngangsbillett:<br />
                                                        <span className="block mt-1 ml-2">• 0-3 år: Forelder betaler, barnet er gratis. Inngang kjøpes på Risenga.</span>
                                                        <span className="block ml-2">• 3-6 år: Barnet betaler, forelder er gratis. Inngang kjøpes på Risenga.</span>
                                                    </>
                                                );
