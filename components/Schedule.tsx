      ...
      <section id="schedule" className="py-32 bg-[#FAFAF9] scroll-mt-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                ...
                <div className="lg:hidden col-span-1 sticky top-[64px] md:top-[80px] z-30 bg-[#FAFAF9]/95 backdrop-blur-md py-5 -mx-6 px-6 border-b border-slate-200/60 flex flex-col gap-3 shadow-sm transition-all text-left">
                ...
                {SCHEDULE_DATA.map((dayData, index) => (
                    <div key={index} id={`schedule-day-${dayData.day}`} className="space-y-8 scroll-mt-32">
                        {/* Day Header - Sticky */}
                        <div className="sticky top-[156px] lg:top-[80px] z-20 flex flex-col gap-1 border-b border-slate-200 pb-6 bg-[#FAFAF9]/95 backdrop-blur-sm pt-4 transition-all">
