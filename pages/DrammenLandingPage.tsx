...
const DrammenLandingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans">
            <Helmet>
                <title>Babysvømming Drammen | Trygg vanntilvenning og svømmekurs | Idrettsbarna</title>
                <meta name="description" content="Babysvømming og småbarnssvømming i Drammen. Gi barnet ditt en trygg start i vannet med våre erfarne instruktører. Varmt basseng og fokus på vannglede. Meld på her!" />
                <link rel="canonical" href="https://www.læråsvømme.no/svommekurs-drammen" />
            </Helmet>
            ...
            <section className="relative pt-32 pb-20 px-6 lg:pt-48 lg:pb-32 bg-white overflow-hidden">
                <div className="container mx-auto max-w-4xl text-center z-10 relative">
                    <span className="text-blue-600 font-bold tracking-widest uppercase text-xs md:text-sm mb-4 block">
                        Kort vei fra Drammen
                    </span>
                    <h1 className="text-4xl md:text-6xl font-serif text-slate-900 mb-6 leading-tight">
                        Babysvømming - Kun en kort tur fra Drammen <br className="hidden md:block" />
                        <span className="italic text-slate-600 font-light">– Velkommen til Risenga i Asker</span>
                    </h1>
                    <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                        Leter du etter svømmekurs i Drammen? <br/>
                        **Idrettsbarna** holder til i det flotte varmtvannsbassenget på Risenga Svømmehall i Asker. Det er kun en kort kjøretur unna Drammen, og vel verdt turen for de gode fasilitetene.
                    </p>
            ...
            <section className="py-20 px-6 bg-slate-50 border-t border-slate-200">
                <div className="container mx-auto max-w-5xl">
                    <h2 className="text-3xl md:text-4xl font-serif text-center mb-16 text-slate-900">Våre kurstilbud i Drammen</h2>
            ...
            <section className="py-20 px-6 bg-white">
                <div className="container mx-auto max-w-4xl">
                    <h2 className="text-3xl md:text-4xl font-serif text-center mb-12 text-slate-900">Hvorfor velge Idrettsbarna i Drammen?</h2>
                    ...
                    <div className="grid sm:grid-cols-2 gap-x-12 gap-y-8">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 text-sm">Risenga ligger kun en kort kjøretur fra Drammen sentrum, og har gode parkeringsmuligheter.</p>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <section className="py-20 px-6 bg-slate-50 border-t border-slate-200">
                <div className="container mx-auto max-w-3xl">
                    <h2 className="text-3xl md:text-4xl font-serif text-center mb-12 text-slate-900">Spørsmål og svar om svømming i Drammen</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <h4 className="font-bold text-slate-900 mb-2">Hvor lang tid tar det å kjøre fra Drammen?</h4>
                            <p className="text-slate-600 text-sm">Fra Drammen sentrum tar det ca. 15-20 minutter med bil til Risenga. Det er enkel parkering rett utenfor.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                    ...
                    <div className="mt-12 text-center">
                         <h3 className="text-xl font-serif text-slate-900 mb-6">Velkommen til Asker</h3>
                          <p className="text-slate-600 max-w-lg mx-auto mb-8">
                            Vi holder til i Risenga Svømmehall. Ta turen fra Drammen for en kvalitetsøkt i vannet med ditt barn.
...
export default DrammenLandingPage;
